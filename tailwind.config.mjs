	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				...
				h3: ['32px', { lineHeight: '110%', letterSpacing: '-0.01em' }],
				'h3-lg': ['36px', { lineHeight: '110%', letterSpacing: '-0.01em' }],
				h4: ['20px', { lineHeight: '120%', letterSpacing: '-0.01em' }],
				'h4-lg': ['32px', { lineHeight: '120%', letterSpacing: '-0.01em' }],
				h5: ['20px', { lineHeight: '120%', letterSpacing: '-0.01em' }],
				'h5-lg': ['24px', { lineHeight: '120%', letterSpacing: '-0.01em' }],
